...
- [ ] Object image cache spike: evaluate Vercel Blob, Cloudflare R2, or S3-compatible storage for public work/activity images, with remote DLsite image URLs preserved as fallback.
