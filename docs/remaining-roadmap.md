...
- [ ] Vercel read-only prototype: deploy only the Next frontend and a small read-only cache API to Vercel; do not move Chrome Companion imports, DLsite cookies, account data, purchase snapshots, or local maintenance operations into Vercel.
