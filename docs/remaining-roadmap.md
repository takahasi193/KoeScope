...
- [ ] Local overlay integration: keep local watchlist, account points, purchased works, subscriptions, and annotations as a private overlay applied after public cached results load.
